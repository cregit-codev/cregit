 ...
 */
  ...
  class Emails(tag:Tag) extends Table[(Int,
    String, String, String, String, String, String, String,
    Int, Int,
    String, Boolean, String)](tag, "emails") {
    def recordid = column[Int]("recordid", O.PrimaryKey)

    def personid = column[String]("personid",  O.SqlType("TEXT"))
    def fullemail  = column[String]("fullemail", O.SqlType("TEXT"), O.SqlType("UNIQUE"))
    def emailaddr = column[String]("emailaddr",  O.SqlType("TEXT"))
    def emailname = column[String]("emailname",  O.SqlType("TEXT"))
    def lcemailaddr = column[String]("lcemail",  O.SqlType("TEXT"))
    ...
    def * = (recordid, personid, fullemail, emailaddr, emailname,
      lcemailaddr, userid, domain, autcount, comcount,
  ...
  def write_database(
    ...
    val schema = emails.schema ++ persons.schema
    ...
    val newEmails = records.toSeq.sortBy{_._1}.
